...
# DEV_DATABASE_URL = "postgresql+psycopg://postgres:postgres@dev_db:5432/tasty_dev_db"
...
# DEV_DATABASE_URL = "postgresql+psycopg://postgres:postgres@localhost:5455/postgres"
